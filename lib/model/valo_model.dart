...
//
//     final valorant = valorantFromJson(jsonString);

import 'dart:convert';

Valorant valorantFromJson(String str) => Valorant.fromJson(json.decode(str));

String valorantToJson(Valorant data) => json.encode(data.toJson());
...
class Valorant {
    ...
    factory Valorant.fromJson(Map<String, dynamic> json) => Valorant(
        status: json["status"],
